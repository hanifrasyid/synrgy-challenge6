...
public class EmailTemplate {
    public String getRegisterTemplate() {
        return "<!DOCTYPE html>\n" +
                ...
                "\t\t<p>Halo <span class=\"user-name\">{{USERNAME}}</span> Selamat bergabung di BinarFud!</p>\n" +
                "\t\t<p>Harap konfirmasikan email kamu dengan memasukan kode di bawah ini</p>\n" +
                "\t\t\n" +
                "\t\tkode: <b>{{VERIFY_TOKEN}}</b>\n" +
                "\t\t\n" +
                "\t\t<p class=\"mt--15\">Jika kamu butuh bantuan atau pertanyaan, hubungi customer care kami di +6281227794142 atau kirim email ke rasyid.cs@binarfud.com</p>\n" +
                "\t\t\n" +
    ...
    public String getResetPassword(){
        ...
        return "<!doctype html>\n" +
                ...
                "<p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">\n" +
                "If this action wasn’t done by you, please contact us on <b>rasyid.cs@binarfud.com</b>. But if it’s you, you can ignore this message. </p>" +
                "</td>\n"+
                "</tr>\n"+
                "<tr>\n" +
                "<td style=\"height:40px;\">&nbsp;</td>" +
